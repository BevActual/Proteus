...
| Doc | Role |
|-----|------|
| [proteus/POSITIONING.md](proteus/POSITIONING.md) | What it is, field comparison, white space |
| [proteus/ARCHITECTURE.md](proteus/ARCHITECTURE.md) | Layers, ownership, HARD RULES |
