...
| Smoke suite (`scripts/smoke/*-smoke.sh`) | `shipped` — layout · widget-layout-resolve · ipc-contract · config-schema · config-roundtrip · app-manifest · chrome-tokens · software-reliability · power-logind · accounts · lock-pin · permissions · desktop · audio-mix-serve · hw-probe · install · session · posture-hard · qs-version; optional `qs-guest` (incl. Customize + widgets IPC + Desktop nav) + `software-guest` via `smoke-all` / `PROTEUS_GUEST=1` |
...
| `./scripts/smoke-all.sh` | Host smokes (layout · widget-layout-resolve · ipc-contract · config-schema · config-roundtrip · app-manifest · chrome-tokens · software-reliability · power-logind · accounts · lock-pin · permissions · desktop · audio-mix-serve · hw-probe · install · session · posture-hard · qs-version); guest `qs-guest` + `software-guest` if SSH or `PROTEUS_GUEST=1` |
