...
# Usage (guest):
#   bash /mnt/proteus/dev/dogfood/dogfood-host.sh
#   bash /mnt/proteus/dev/dogfood/dogfood-host.sh --attach   # after headless, attach seat
#   bash /mnt/proteus/dev/dogfood/dogfood-host.sh --restore  # flip back to desktop
set -euo pipefail
