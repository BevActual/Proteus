...
grep -q 'MixDragStart\|MixDragHover\|MixDragEnd\|finish_mix_drag\|free-pointer grip' \
  "${ST_ROOT}/src/panes/sound.rs" "${ST_ROOT}/src/main.rs" \
  && ok "Mixer free-pointer drag thin" || bad "Mixer free-pointer drag missing"
