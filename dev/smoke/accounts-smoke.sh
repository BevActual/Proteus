...
grep -q 'Accounts.qml' "${ROOT}/dev/smoke/layout-smoke.sh" || die "layout-smoke requires Accounts.qml"
...
grep -q 'CalendarEvents.qml' "${ROOT}/dev/smoke/layout-smoke.sh" \
...
grep -q 'MailGlance.qml' "${ROOT}/dev/smoke/layout-smoke.sh" \
...
grep -q 'ContactsGlance.qml' "${ROOT}/dev/smoke/layout-smoke.sh" \
